...
class SampleValidator extends Validator
{
    ...
    public function getData2($parameter)
    {
    ...
    public function getAffectedFields2($fields)
    {
        $this->AffectedFieldNames = $fields;
        return $this->getAffectedFields();
    }
    public function export2($value)
    {
        $this->export($value);
    }
    ...
    protected function validateInBase(VirtualArrayPath $base)
    {
        ...
        return parent::validateInBase($base);
    }
    public function validateInBase2($base)
    {
