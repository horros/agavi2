...
class RoutingCasesTest extends UnitTestCase
{
    /**
     * @var SampleRouting
     */
    ...
    public function testSimple()
    {
        ...
        $rq = $r->getContext()->getRequest();
        $rq->setParameter('use_module_controller_parameters', true);
        $rd = $rq->getRequestData();
        ...
        $this->doTestMatch('/parent/category1/MACHINE/', array('test2parent', 'test2child1'), array(
            'module' => 't1Module1', 'controller' => 't2Controller1',
            'category' => 'category1',
            'machine' => 'MACHINE',
        ), 'Input matching a route and children');
        ...
        $this->doTestMatch('/parent/opt,35/p1/part1match/p2/', array('parent', 'child_complex'), array(
            'module' => 'module_parent', 'controller' => 'controller_child_complex',
            'parent_id' => '23',
            'optional1' => '35',
            'part1' => 'part1match',
        ...
        $this->doTestMatch('/en/parent/42/', array('left_anchored_nonstop', 'parent', 'child_simple'), array(
            'module' => 'module_parent', 'controller' => 'controller_child_simple',
            'language' => 'en',
            'parent_id' => '42',
            'part1' => 'part1_default',
            'part2' => 'part2_default',
