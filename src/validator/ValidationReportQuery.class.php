 ...
 * @version    $Id$
 */
class ValidationReportQuery implements ValidationReportQueryInterface
{
    /**
    ...
    /**
     * Returns a new ValidationReportQueryInterface implementation which contains only the incidents
     * of the given severity or higher (and the other existing filter rules).
     *
     * @param      int $minSeverity The minimum severity.
     *
     * @return     ValidationReportQueryInterface
     *
     * @author     Dominik del Bondio <dominik.del.bondio@bitextender.com>
     * @since      1.0.0
     */
     ...
     * defined filter rules.
     *
     * @return     ValidationArgument[] An array of ValidationArgument objects.
     *
     * @author     Dominik del Bondio <dominik.del.bondio@bitextender.com>
     * @since      1.0.0
     */
            ...
            if (count($this->argumentFilter) == 1) {
                ...
                foreach ($this->report->getArgumentResults() as $argumentResults) {
                    foreach ($argumentResults as $argumentResult) {
                        if ((!$this->argumentFilter || in_array($argumentResult['argument'], $this->argumentFilter)) &&
