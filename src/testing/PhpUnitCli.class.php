...
class PhpUnitCli extends \PHPUnit_TextUI_Command
{
	 ...
	 *
	 * @param      string $value The Agavi environment name.
	 *
	 * @author     Dominik del Bondio <dominik.del.bondio@bitextender.com>
	 * @since      1.1.0
	 */
	 ...
	 *
	 * @param      string $value The suite names, separated by comma, to include.
	 *
	 * @author     Dominik del Bondio <dominik.del.bondio@bitextender.com>
	 * @since      1.1.0
	 */
	 ...
	 *
	 * @param      string $value The suite names, separated by comma, to exclude.
	 *
	 * @author     Dominik del Bondio <dominik.del.bondio@bitextender.com>
	 * @since      1.1.0
	 */
...
EOT;
	 ...
	 * @param      array  $suite An array containing information about the suite
	 *
	...
	public static function bootstrap($environment = null)
	{
		...
		if($environment === null) {
			// still no env? oh man...
			throw new AgaviException('You must supply an environment name to Testing::bootstrap() or set the name of the default environment to be used for testing in the configuration directive "testing.environment".');
		}
