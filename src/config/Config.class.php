...
/**
 * Config acts as global registry of agavi related configuration settings
 *
 * @package    agavi
 * @subpackage config
 *
...
class Config
{
     ...
     * @param      string $default The default value if directive is not found
     *
     * @return     mixed The value of the directive, or the default value or null if the default value is not set.
     *
     * @author     David Zülke <dz@bitxtender.com>
     * @since      0.11.0
     */
