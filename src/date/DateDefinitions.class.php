 ...
 * @version    $Id$
 */
final class DateDefinitions
{
	/** 
	 * Field number indicating the era, e.g., {@link GregorianCalendar::AD}
	 * or {@link GregorianCalendar::BC} in the Gregorian (Julian) calendar.
	 * 
	 ...
	 * @since      0.11.0
	 */
	const DAY_OF_MONTH            = DateDefinitions::DATE;
