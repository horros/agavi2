...
use Agavi\View\FileTemplateLayer;
 ...
 * @version    $Id$
 */
class TwigRendererInterface extends Renderer implements ReusableRendererInterface
{
    /**
    ...
    public function initialize(Context $context, array $parameters = array())
    {
        ...
        $this->setParameter('options', array_merge(
            array(
                ...
                'cache' => Config::get('core.debug') ? false : Config::get('core.cache_dir') . DIRECTORY_SEPARATOR . 'templates' . DIRECTORY_SEPARATOR . 'twig',
            ),
    ...
    public function render(TemplateLayer $layer, array &$attributes = array(), array &$slots = array(), array &$moreAssigns = array())
    {
        ...
        if ($layer instanceof FileTemplateLayer) {
            ...
            foreach ((array)$this->getParameter('template_dirs', array(Config::get('core.template_dir'))) as $dir) {
                $paths[] = $dir;
            }
