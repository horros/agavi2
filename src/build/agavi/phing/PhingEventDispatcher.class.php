...
// |   End:                                                                    |
// +---------------------------------------------------------------------------+
use Agavi\Build\Event\EventDispatcher;
 ...
 * @version    $Id$
 */
final class PhingEventDispatcher extends EventDispatcher implements \BuildListener
{
	/**
	...
	/**
	 * @var        PhingTargetListenerInterface[] An array of PhingTargetListenerInterface instances.
	 */
	protected $targetListeners = array();
	
	/**
	 * @var        PhingTaskListenerInterface[] An array of PhingTaskListenerInterface instances.
	 */
	protected $taskListeners = array();
	
	/**
	 * @var        PhingMessageListenerInterface[] An array of PhingMessageListenerInterface instances.
	 */
	 ...
	 *
	 * @param      \Project $project The project that governs the dispatcher.
	 *
	 * @author     Noah Fontes <noah.fontes@bitextender.com>
	 * @since      1.0.0
	 */
	 ...
	 *
	 * @param      PhingTargetListenerInterface $listener The target listener.
	 *
	 * @author     Noah Fontes <noah.fontes@bitextender.com>
	 * @since      1.0.0
	 */
	public function addTargetListener(PhingTargetListenerInterface $listener)
	{
	 ...
	 *
	 * @param      PhingTaskListenerInterface $listener The task listener.
	 *
	 * @author     Noah Fontes <noah.fontes@bitextender.com>
	 * @since      1.0.0
	 */
	public function addTaskListener(PhingTaskListenerInterface $listener)
	{
	 ...
	 *
	 * @param      PhingMessageListenerInterface $listener The message listener.
	 *
	 * @author     Noah Fontes <noah.fontes@bitextender.com>
	 * @since      1.0.0
	 */
	public function addMessageListener(PhingMessageListenerInterface $listener)
	{
	 ...
	 *
	 * @param       \BuildEvent $phingEvent The Phing build event.
	 *
	 * @author     Noah Fontes <noah.fontes@bitextender.com>
	 * @since      1.0.0
	 */
