 ...
 * @version    $Id$
 */
class BuildLogger extends \DefaultLogger
{
	/**
	 ...
	 *
	 * @param      \DefaultLogger $logger The logger to which this logger should write.
	 *
	 * @author     Noah Fontes <noah.fontes@bitextender.com>
	 * @since      1.0.0
	 */
	 ...
	 *
	 * @param      \OutputStream $output The output stream.
	 *
	 ...
	 *
	 * @param      \OutputStream $error The error stream.
	 *
	 * @see        DefaultLogger::setOutputStream()
	 *
	 * @author     Noah Fontes <noah.fontes@bitextender.com>
	 ...
	 *
	 * @param      \BuildEvent $event An event containing the data to be logged.
	 *
