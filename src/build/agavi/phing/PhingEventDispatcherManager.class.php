 ...
 * @version    $Id$
 */
final class PhingEventDispatcherManager
{
	/**
	 * @var        array List of PhingEventDispatcher instances.
	 */
	 ...
	 *
	 * @return     PhingEventDispatcher The dispatcher.
	 *
	 * @author     Noah Fontes <noah.fontes@bitextender.com>
	 * @since      1.0.0
	 */
	public static function get(\Project $project)
	{
		...
		if(!isset(self::$dispatchers[$hash])) {
			self::$dispatchers[$hash] = new PhingEventDispatcher($project);
		}
