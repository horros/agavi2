...
class ProxyTarget extends \Target
{
	 ...
	 *
	 * @param      \Target $target The target to proxy.
	 *
	 * @author     Noah Fontes <noah.fontes@bitextender.com>
	 * @since      1.0.0
	 */
	 ...
	 * Proxies task adding.
	 *
	 * @param      \Task $task The task that is being added.
	 *
	 * @author     Noah Fontes <noah.fontes@bitextender.com>
	 * @since      1.0.0
	 */
	 ...
	 *
	 * @param      \DataType $type The datatype that is being added.
	 *
	 * @author     Noah Fontes <noah.fontes@bitextender.com>
	 * @since      1.0.0
	 */
	 ...
	 *
	 * @param      string $property The condition.
	 *
	 * @author     Noah Fontes <noah.fontes@bitextender.com>
	 * @since      1.0.0
	 */
	...
	public function main()
	{
		...
		foreach($thisProject->getProperties() as $name => $property) {
			if(!ProxyProject::isPropertyProtected($name) && $project->getProperty($name) === null) {
		...
		foreach($project->getProperties() as $name => $property) {
			if(!ProxyProject::isPropertyProtected($name) && $thisProject->getProperty($name) === null) {
