...
// |   End:                                                                    |
// +---------------------------------------------------------------------------+
use Agavi\Build\Exception\EventBuildException;
...
class Event implements EventInterface
{
	 ...
	 *
	 * @param      object $source This event's source.
	 *
	 * @author     Noah Fontes <noah.fontes@bitextender.com>
	 * @since      1.0.0
	 */
	...
	{
		if($this->source !== null) {
			throw new EventBuildException('An event source may not be set multiple times');
		}
		$this->source = $source;
	}
}
