...
/**
 * RequestDataHolder provides methods for retrieving client request
 ...
 * @version    $Id$
 */
class RequestDataHolder extends ParameterHolder implements ParametersRequestDataHolderInterface
{
    /**
     ...
     *
     * @param      string $name The source name, typically passed using a constant.
     * @param      array  $holder The variable that will hold the data for the source.
     *
     * @author     David Zülke <dz@bitxtender.com>
     * @since      0.11.0
     */
    final protected function registerSource($name, array &$holder)
    {
        ...
        $this->sourceNames[$name] = Inflector::singularize($name);
    }
     ...
     * @since      0.11.0
     */
    public function merge(RequestDataHolder $other)
    {
