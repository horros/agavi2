...
abstract class TemplateLayer extends ParameterHolder
{
     ...
     * @since      0.11.0
     */
    public function execute(Renderer $renderer = null, array &$attributes = array(), array &$moreAssigns = array())
    {
        $output = array();
     ...
     * @param      ExecutionContainer $c The slot's execution container.
     *
     * @author     David Zülke <dz@bitxtender.com>
     * @since      0.11.0
     */
    public function setSlot($name, ExecutionContainer $c)
    {
        $this->slots[$name] = $c;
    }
     ...
     * @param      string $name The name of the slot.
     *
     * @return     ExecutionContainer The slot's execution container.
     *
     * @author     David Zülke <dz@bitxtender.com>
     * @since      0.11.0
     */
