...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="<?php echo $locale->getLocaleLanguage(); ?>" lang="<?php echo $locale->getLocaleLanguage(); ?>"<?php if ($locale->getCharacterOrientation() == 'right-to-left') :
?> dir="rtl"<?php
                                                     endif; ?>>
    <head>
