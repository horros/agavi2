...
class Default_Widgets_MenuSuccessView extends SampleAppDefaultBaseView
{
	...
	public function executeHtml(RequestDataHolder $rd)
	{
		...
		$items[$this->ro->gen('confidential.secret')] = $this->tm->_('A Secure Controller', 'default.menu');
		$items[$this->ro->gen('confidential.topsecret')] = $this->tm->_('Another Secure Controller', 'default.menu');
